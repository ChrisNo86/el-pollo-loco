...
export class ThrowableObject extends MovableObject {
  ...
  checkIfOnGround() {
    if (this.y >= this.groundY || endBossHit) {
      if (!this.splashActive) this.startSplash();
  ...
  /**
   * Resizes the object to the splash artwork's aspect ratio and keeps its
   * bottom edge on the ground line so the splash doesn't sink below the floor.
   */
  startSplash() {
